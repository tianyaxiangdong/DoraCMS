...
//文档新增/编辑
doraApp.controller("modifyConfig", ['$scope', '$http', 'pageData', 'getItemService', function ($scope, $http, pageData, getItemService) {
    $scope.formData = {};
    debugger;
    $http({
        url: '/admin/manage/modifyConfig/list',
        ...
        if (data.length > 0) {
            console.info(data);
            var _data = data[0];
            $scope.formData._id = _data._id;
            $scope.formData.pic1 = _data.pic1;
            $scope.formData.pic2 = _data.pic2;
            $scope.formData.pic3 = _data.pic3;
            $scope.formData.pic4 = _data.pic4;
            $scope.formData.pic5 = _data.pic5;
            $scope.formData.pic6 = _data.pic6;
            $scope.formData.pic7 = _data.pic7;
            $scope.formData.pic8 = _data.pic8;
            $("#myImg").attr("src", _data.pic1);
            $("#myImg2").attr("src", _data.pic2);
            $("#myImg3").attr("src", _data.pic3);
            $("#myImg4").attr("src", _data.pic4);
            $("#myImg5").attr("src", _data.pic5);
    ...
    initUploadFyBtn('uploadContentImg', 'images', "ctTopImg", function (data) {
        $.tipsShow({
            ...
            callBack: function () {
                $("#myImg").attr("src", data);
                $scope.formData.pic1 = data;
            }
        });
    });
    initUploadFyBtn('pic2', 'images', "ctTopImg", function (data) {
        $.tipsShow({
            message: '上传成功',
            type: 'success',
            callBack: function () {
                $("#myImg2").attr("src", data);
                $scope.formData.pic2 = data;
            }
        });
    });
    initUploadFyBtn('pic3', 'images', "ctTopImg", function (data) {
        $.tipsShow({
            message: '上传成功',
            type: 'success',
            callBack: function () {
                $("#myImg3").attr("src", data);
                $scope.formData.pic3 = data;
            }
        });
    });
    initUploadFyBtn('pic4', 'images', "ctTopImg", function (data) {
        $.tipsShow({
            message: '上传成功',
            type: 'success',
            callBack: function () {
                $("#myImg4").attr("src", data);
                $scope.formData.pic4 = data;
            }
        });
    });
    initUploadFyBtn('pic5', 'images', "ctTopImg", function (data) {
        $.tipsShow({
            message: '上传成功',
            type: 'success',
            callBack: function () {
                $("#myImg5").attr("src", data);
                $scope.formData.pic5 = data;
            }
        });
    });
    initUploadFyBtn('pic6', 'images', "ctTopImg", function (data) {
        $.tipsShow({
            message: '上传成功',
            type: 'success',
            callBack: function () {
                $("#myImg6").attr("src", data);
                $scope.formData.pic6 = data;
            }
        });
    });
    initUploadFyBtn('pic7', 'images', "ctTopImg", function (data) {
        $.tipsShow({
            message: '上传成功',
            type: 'success',
            callBack: function () {
                $("#myImg7").attr("src", data);
                $scope.formData.pic7 = data;
            }
        });
    });
    initUploadFyBtn('pic8', 'images', "ctTopImg", function (data) {
        $.tipsShow({
            message: '上传成功',
            type: 'success',
            callBack: function () {
    ...
    $scope.processForm = function () {
        angularHttpPost($http, true, getTargetPostUrl($scope, pageData.bigCategory), $scope.formData, function (data) {
            window.location = "/admin/manage/modifyConfig";
        });
    };
